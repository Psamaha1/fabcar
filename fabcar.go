...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	cars := []Car{
		Car{Temperature: "Toyota", Humidity: "Prius", Colour: "blue", Owner: "Tomoko"},
		Car{Temperature: "Ford", Humidity: "Mustang", Colour: "red", Owner: "Brad"},
		Car{Temperature: "Hyundai", Humidity: "Tucson", Colour: "green", Owner: "Jin Soo"},
		Car{Temperature: "Volkswagen", Humidity: "Passat", Colour: "yellow", Owner: "Max"},
		Car{Temperature: "Tesla", Humidity: "S", Colour: "black", Owner: "Adriana"},
		Car{Temperature: "Peugeot", Humidity: "205", Colour: "purple", Owner: "Michel"},
		Car{Temperature: "Chery", Humidity: "S22L", Colour: "white", Owner: "Aarav"},
		Car{Temperature: "Fiat", Humidity: "Punto", Colour: "violet", Owner: "Pari"},
		Car{Temperature: "Tata", Humidity: "Nano", Colour: "indigo", Owner: "Valeria"},
		Car{Temperature: "Holden", Humidity: "Barina", Colour: "brown", Owner: "Shotaro"},
	}
...
func (s *SmartContract) createPrivateCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	type carTransientInput struct {
		Temperature string `json:"Temperature"` //the fieldtags are needed to keep case from bouncing around
		Humidity    string `json:"Humidity"`
	...
	if len(carInput.Temperature) == 0 {
		return shim.Error("color field must be a non-empty string")
	}
	if len(carInput.Humidity) == 0 {
		return shim.Error("Humidity field must be a non-empty string")
	}
	...
	var car = Car{Temperature: carInput.Temperature, Humidity: carInput.Humidity, Colour: carInput.Color, Owner: carInput.Owner}
...
func (s *SmartContract) createCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var car = Car{Temperature: args[1], Humidity: args[2], Colour: args[3], Owner: args[4], Size: args[5]}
...
func (s *SmartContract) createPrivateCarImplicitForOrg1(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var car = Car{Temperature: args[1], Humidity: args[2], Colour: args[3], Owner: args[4]}
